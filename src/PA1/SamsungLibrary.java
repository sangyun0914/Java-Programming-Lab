...
public class SamsungLibrary extends JFrame {
    private static final String CLASS_NAME = "Samsung Library";
    private static Library samsungLib = Main.samsungLib;
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    SamsungLibrary frame = new SamsungLibrary();
     ...
     * Create the frame.
     */
    public SamsungLibrary() {
        setTitle(samsungLib.getName());
        ...
        String text = "Samsung" + "<br>" + "LIBRARY";
        ...
        btnBorrow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (samsungLib.getIndex(ID) == -1) {
                    ...
                    samsungLib.getBook(samsungLib.getIndex(ID)).Borrow();
                    getBooks();
                }
        ...
        btnBorrow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (samsungLib.getIndex(ID) == -1) {
                    ...
                    if (samsungLib.getBook(samsungLib.getIndex(ID)).getAvail() == false) {
    ...
    public static void getBooks() {
        model.setRowCount(0);
        for (int i = 0; i < samsungLib.getCount(); i++) {
            if (samsungLib.getBook(i).getAvail()) {
                Vector<String> v = new Vector<String>();
                v.add(Integer.toString(samsungLib.getBook(i).getID()));
                v.add(samsungLib.getBook(i).getTitle());
                v.add(samsungLib.getBook(i).getAuthor());
                v.add(Integer.toString(samsungLib.getBook(i).getYear()));
                model.addRow(v);
            }
        }
    }
